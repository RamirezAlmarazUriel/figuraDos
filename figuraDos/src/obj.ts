...
export class Obj {
   rho:number; theta:number = -1; phi:number = 1; d:number; objSize:number;
   ...
   constructor() {
      ...
      // Top surface:
      this.w[4] = new Point3D( 0.3, -0.5,   0.3);
      this.w[5] = new Point3D( 0.3,   0.5,   0.3);
      this.w[6] = new Point3D(-0.3,   0.5,   0.3);
      this.w[7] = new Point3D(-0.3, -0.5, 0.3);
